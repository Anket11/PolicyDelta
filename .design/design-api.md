...
# PolicyDelta — API & Service Architecture
...
from policydelta.core.config import settings
...
engine: AsyncEngine = create_async_engine(
    ...
    connect_args={
        ...
        "server_settings": {"application_name": "policydelta-api"},
    },
)
...
from policydelta.core.db import get_session
from policydelta.core.errors import Unauthorized, Forbidden
...
class AppError(Exception):
    status: int = 500
    type_: str = "about:blank"     # stable URN slug, e.g. "urn:policydelta:error:not-found"
